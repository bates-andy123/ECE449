...
architecture behavioural of test_alu is
    ...
    signal rst, clk, wr_enable, n, z : std_logic; 
    signal rd_index1, rd_index2, wr_index, mode : std_logic_vector(2 downto 0); 
    signal rd_data1, rd_data2, wr_data, result : std_logic_vector(15 downto 0); 
    begin
    u0:register_file port map(rst, clk, rd_index1, rd_index2, rd_data1, rd_data2, wr_index, wr_data, wr_enable);
    u1:alu port map(in1=>rd_data1, in2=>rd_data2, mode=>mode , clk=>clk, rst=>rst, result=>result, n=>n, z=>z);
    process begin
        clk <= '0'; wait for 10 us;
        clk<='1'; wait for 10 us; 
    end process;
    process  begin
        rst <= '1'; rd_index1 <= "000"; rd_index2 <= "000"; wr_enable <= '0'; wr_index <= "000"; mode<="001";
        wr_data <= X"0000";
